...
public class AuthService {
    ...
    public UserDTO registerUser(UserRegistrationRequest registerUserReq) {
    ...
    public AuthResponse loginUser(UserLoginRequest userData) throws AuthenticationException {
        String accessToken = "";
        String refreshToken = "";
    ...
    public AuthResponse getSessionTokensForOAuthUsers(String authCode) {
    ...
    public User convertDTOToEntity(UserRegistrationRequest userDTO) {
        User user = new User();
